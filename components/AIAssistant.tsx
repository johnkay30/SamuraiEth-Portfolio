    ...
    <section id="about" className="py-16 md:py-24 px-4 sm:px-6 bg-[#080808] relative">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col items-center mb-10 md:mb-16 text-center">
          <span className="text-[#3b82f6] uppercase tracking-widest text-[10px] font-black mb-4 block">Visual Engineering</span>
          <h2 className="text-2xl md:text-5xl font-black uppercase font-jp mb-4">The <span className="text-[#3b82f6]">SAMURAI.ETH</span> Standard</h2>
          <p className="text-xs md:text-lg text-gray-300 font-light max-w-2xl px-2 leading-relaxed">
            Forging high-fidelity narratives and technical visual engineering for the decentralized frontier.
          </p>
        </div>
          ...
          <div className="bg-[#0f0f0f] border border-white/10 rounded-2xl overflow-hidden shadow-2xl relative group">
            ...
            <div className="aspect-video w-full bg-black">
              <iframe 
                ...
                title="SAMURAI.ETH Welcome Video"
            ...
            <div className="p-4 md:p-6 bg-black/40 border-t border-white/5">
              <p className="text-xs md:text-sm text-gray-400 font-light italic">
                Mission briefing: Visual impact analysis and creative philosophy for high-performance Web3 storytelling.
              </p>
            </div>
          </div>
        </div>
