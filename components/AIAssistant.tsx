    ...
    <section id="about" className="py-16 md:py-24 px-4 sm:px-6 bg-[#080808] relative">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col items-center mb-10 md:mb-16 text-center">
          ...
          <h2 className="text-2xl md:text-5xl font-black uppercase font-jp mb-4">The <span className="text-samurai">SAMURAIETH</span> Standard</h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-[#0f0f0f] border border-white/10 rounded-2xl overflow-hidden shadow-2xl relative group">
            <div className="absolute top-4 left-4 z-10 flex items-center gap-2 bg-black/80 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/10">
              ...
              <span className="text-[8px] font-black uppercase tracking-widest text-white/90">WELCOME_MISSION.EXE</span>
            </div>
            <div className="aspect-video w-full bg-black">
              <iframe 
                src="https://www.youtube-nocookie.com/embed/0Cov_mpdUkk?autoplay=1&mute=1&rel=0&modestbranding=1&playsinline=1" 
                title="SAMURAIETH Welcome Video"
