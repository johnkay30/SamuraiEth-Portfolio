            ...
            <div 
              ...
              className={`group relative overflow-hidden bg-black flex flex-col cursor-pointer border transition-all duration-500 z-0 hover:z-10 ${
                playingId === project.id 
                  ...
                  : 'border-white/5 hover:border-samurai/40 hover:scale-[1.03] hover:shadow-[0_0_30px_rgba(255,0,0,0.15)]'
              }`}
            >
              <div className="relative aspect-video overflow-hidden">
                {playingId === project.id ? (
                  <div className="relative w-full h-full bg-black">
                    ...
                    <button 
                      onClick={stopVideo}
                      className="absolute top-4 right-4 z-20 bg-samurai text-white w-10 h-10 flex items-center justify-center rounded-full hover:bg-red-700 transition-colors shadow-lg"
                    >
                  ...
                  <>
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black via-black/30 to-transparent p-6 flex flex-col justify-end transform transition-transform duration-300">
                ...
                {/* Subtle border highlight element for extra precision */}
              ...
              {/* Description visible below video when playing */}
              {playingId === project.id && (
                <div className="p-6 bg-white/5 border-t border-samurai/20 animate-fade-in">
                  <span className="text-samurai text-[10px] font-black uppercase tracking-widest mb-2 block">{project.category}</span>
