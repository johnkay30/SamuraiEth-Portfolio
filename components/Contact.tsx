  ...
  return (
    <section id="contact" className="py-24 px-6 bg-black relative">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16">
        <div className="lg:w-1/2">
          ...
          <p className="text-gray-400 text-lg font-light mb-12 max-w-md">
            Ready to elevate your project to the next level? Fill out the form or reach out directly on social media. The blade is ready.
          </p>
          ...
          <div className="flex flex-col gap-6">
            <a href="#" className="flex items-center gap-4 group">
              ...
              <div>
                ...
                <p className="text-white font-bold">@SamuraiEth_Edits</p>
              </div>
            </a>
            <a href="#" className="flex items-center gap-4 group">
              <div className="w-12 h-12 bg-white/5 flex items-center justify-center rounded group-hover:bg-samurai transition-colors">
              ...
              <div>
                ...
                <p className="text-white font-bold">SamuraiEth#1337</p>
              </div>
            </a>
            <a href="#" className="flex items-center gap-4 group">
              <div className="w-12 h-12 bg-white/5 flex items-center justify-center rounded group-hover:bg-samurai transition-colors">
              ...
              <div>
                ...
                <p className="text-white font-bold">contact@samuraieth.com</p>
              </div>
            </a>
          </div>
        </div>
      ...
      <div className="mt-24 border-t border-white/5 pt-12 text-center text-gray-600 text-[10px] uppercase tracking-[0.5em]">
        © {new Date().getFullYear()} SamuraiEth • Forged in the Digital Dojo
      </div>
    </section>
  );
};
